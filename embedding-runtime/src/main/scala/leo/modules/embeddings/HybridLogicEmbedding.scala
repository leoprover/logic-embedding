...
object HybridLogicEmbedding extends Embedding {
  ...
  override type OptionType = HybridLogicEmbeddingOption.type
  ...
  override final def apply(problem: TPTP.Problem,
    ...
    new HybridLogicEmbeddingImpl(problem, embeddingOptions).apply()
  ...
  /////////////////////////////////////////////////////////////////////////////////
  /////////////////////////////////////////////////////////////////////////////////
  private[this] final class HybridLogicEmbeddingImpl(problem: TPTP.Problem, embeddingOptions: Set[HybridLogicEmbeddingOption.Value]) {
    import HybridLogicEmbeddingOption._
    ...
    def apply(): TPTP.Problem = {
      ...
      val generatedMetaPostUserFormulas: Seq[AnnotatedFormula] = generateMetaPostUserFormulas()

      val result = generatedMetaFormulas ++ convertedTypeFormulas ++ generatedMetaPostUserFormulas ++ convertedDefinitionFormulas ++ convertedOtherFormulas
    ...
    private[this] val nominals: mutable.Set[String] = mutable.Set.empty
    private[this] def nominal(nom: String): Unit = {
      nominals += nom
    }
    ...
    private def generateMetaFormulas(): Seq[TPTP.AnnotatedFormula] = {
      ...
      /////////////////////////////////////////////////////////////
      // First: Introduce world type and nominal type
      result.appendAll(worldTypeTPTPDef())
    ...
    private def generateMetaPostUserFormulas(): Seq[TPTP.AnnotatedFormula] = {
      import scala.collection.mutable
    ...
    private[this] def worldTypeTPTPDef(): Seq[TPTP.AnnotatedFormula] = {
      import modules.input.TPTPParser.annotatedTHF
      Seq(
    ...
    private[this] def nominalMetaAxiomTPTPDef(nom: String): Seq[TPTP.AnnotatedFormula] = {
      ...
      Seq(
        annotatedTHF(s"thf(${escapeAtomicWord(name)}, axiom, ?[W:$worldTypeName]: ((${escapeAtomicWord(nom)} @ W) & (![V:$worldTypeName]: ((V != W) => (~(${escapeAtomicWord(nom)} @ V))))) ).")
      )
    }
    ...
    private[this] def createState(spec: TPTP.AnnotatedFormula): Unit = {
      ...
      spec.formula match {
        case THF.Logical(THF.BinaryFormula(THF.==, THF.FunctionTerm("$$hybrid", Seq()),THF.Tuple(spec0))) =>
          spec0 foreach {
