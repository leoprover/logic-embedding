...
object EmbeddingApp {
  ...
  final def main(args: Array[String]): Unit = {
    ...
    if (args.isEmpty) usage()
      ...
      try {
        ...
        // Write result
        val result = generateResult(embeddedProblem, getSpecFromProblem(formulasToBeEmbedded))
  ...
  private[this] final def generateResult(problem: Problem, logicSpec: Option[AnnotatedFormula]): String = {
